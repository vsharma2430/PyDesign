...
class SteelWalkway:
    def __init__(self, edge_line: Line3D, width: float=0.8, thickness: float=0.25, material_type: str='steel', load_capacity: float=300):
        """
        ...
        Args:
            ...
            load_capacity (float): Maximum load capacity in kg/m^2.
        """
    ...
    def get_uniform_load(self):
        return UniformLoad(direction= MemberDirection.GY,force_value=-1*self.width/1000*self.load_capacity/1000/2,load_case=LoadCase.LiveLoad)
